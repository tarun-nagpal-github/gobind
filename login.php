...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo $lumise->cfg->url; ?>assets/css/login.css">
		<script type="text/javascript" src="<?php echo $lumise->cfg->url; ?>/assets/js/jquery.min.js"></script>
	...
	<?php if (isset($_GET['reset-password']) && !empty($_GET['reset-password'])) { ?>
		<div id="login-form" class="reset-password-form">
			<a id="logo" href="<?php echo $lumise->cfg->settings['logo_link']; ?>">
				<img src="<?php echo $lumise->cfg->url; ?>/assets/images/logo_login.png" />
			</a>
			<h1>
