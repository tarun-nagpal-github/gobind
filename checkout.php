                            ...
                            <div class="control-group last payments">
                				...
                				<div class="controls">
                                    ...
                                    <div class="lumise-payment-item">
                                        ...
                                        <!-- <img src="<?php echo $lumise->cfg->url.'assets/images/paypal.png'; ?>" alt="<?php echo $lumise->lang('Paypal payment'); ?>"/> -->
                                        <img src="https://www.searchpng.com/wp-content/uploads/2018/11/Paytm_wallet.png"/>
                                        
                                        <?php echo $lumise->lang('PayTm'); ?></label>
                                    </div>
                                    <div class="lumise-payment-item">
                                        <input name="payment" type="radio" value="cod" id="payment-cod" required>
                                        <label for="payment-cod"><?php echo $lumise->lang('Pay At Shop (Phone - 01676-510231)'); ?></label>
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php foreach($item['attributes'] as $attr => $options):?>
                                                    <p>
                                                        <strong><?php echo $attr ?></strong> : <?php echo implode(', ', $options); ?>
                                                    </p>
                                                <?php endforeach;?>
                                            </td>
