...
<header class="header">
    <div class="container">
        <a href="<?php echo $lumise->cfg->url; ?>" class="logo">
            <img src="http://localhost/lumise/lumise/data/settings/lumise-media-logo-2.jpg" alt="Lumise Product Designer online tool">
        </a>
        <div class="menu">
        ...
        <div class="menu_mobile">
            <a href="<?php echo $lumise->cfg->url; ?>" class="logo_mobile"><img src="http://localhost/lumise/lumise/data/settings/lumise-media-logo-2.jpg" alt="Logo"></a>
