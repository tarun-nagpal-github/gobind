    ...
    public function process_payment($order_data){
        ...
        if($order_data['payment'] == 'paypal'){
            ...
            if($lumise->cfg->settings['sanbox_mode']){
              ...
              $paypal_url = './lib/PaytmKit/pgRedirect.php';
            ?>
            <center>
            <p><?php echo $lumise->lang('Your order placed, now you will be redirect to PayTm to progress payment.'); ?></p>
            <form action="<?php echo $paypal_url; ?>" method="post" id="cartCheckout">
                ...
                <!-- Paytm ORDER_ID -->
                <input type="hidden" id="ORDER_ID" name="ORDER_ID" value="ORDS<?php echo $order_data['id']; ?>">
                ...
                <!-- Paytm TXN_AMOUNT -->
                <input type="hidden" name="TXN_AMOUNT" value="<?php echo $order_data['total']; ?>">
