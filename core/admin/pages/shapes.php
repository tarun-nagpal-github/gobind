...
<div class="lumise_wrapper">
	...
	<div class="lumise_content">
		...
		<div class="lumise_header">
			...
			<a href="<?php echo $lumise_router->getURI();?>lumise-page=shape" class="add_new"><?php echo $lumise->lang('Add New Shape'); ?></a>
			<?php if (isset($shapes['rows']) && count($shapes['rows']) < 3){ ?>
			<a href="<?php echo $lumise_router->getURI();?>lumise-page=shapes&task=import-sample" class="add_new"><?php echo $lumise->lang('Import Sample'); ?></a>
			<?php } ?>
			<?php
