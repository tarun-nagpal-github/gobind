<?php
	...
	$fields = $lumise_admin->process_data(array(
		...
		array(
			...
			'desc' => $lumise->lang('Upload the exported file *.lumi from the Lumise Designer Tool. You can download the LUMI file via menu "File" > Download > FILE (*.lumi), or press CTRL+S.')
		),
		array(
			'type' => 'toggle',
			'name' => 'featured',
	...
	<div class="lumise_content">
		<?php
			$lumise->views->detail_header(array(
				...
				'edit' => $lumise->lang('Edit Template'),
				'page' => $section
			));
		?>
