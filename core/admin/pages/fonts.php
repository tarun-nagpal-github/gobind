<?php
    ...
    $config = array(
		...
		'total_page'    => $fonts['total_page'],
 	    'limit'         => $per_page,
	    'link_full'     => $lumise_router->getURI().'lumise-page=fonts&tpage={page}',
	    'link_first'    => $lumise_router->getURI().'lumise-page=fonts',
	);
...
<div class="lumise_wrapper">
	...
	<div class="lumise_content">
		...
		<div class="lumise_header">
			...
			<a href="<?php echo $lumise_router->getURI();?>lumise-page=font" class="add_new"><?php echo $lumise->lang('Add New Font'); ?></a>
			<?php
		...
		<div class="lumise_message noti">
			<em class="lumise_suc">
				...
				<?php echo $lumise->lang('In addition, Users can also select from over 800+ Google fonts and you can set the list default Google fonts in'); ?>
		...
		<div class="lumise_option">
			<div class="left">
				<form action="<?php echo $lumise_router->getURI();?>lumise-page=fonts" method="post">
							...
							if ( is_array($fonts['rows']) && count($fonts['rows']) > 0 ) {
								...
								foreach ($fonts['rows'] as $value) { ?>
									...
									<tr>
										...
										<td>
											<a href="<?php
												echo $lumise_router->getURI();?>lumise-page=font&id=<?php
		...
		<?php } else {
					if (isset($total_record) && $total_record > 0) {
						...
						$_SESSION[$prefix.'data_search'] = '';
						echo '<a href="'.$lumise_router->getURI().'lumise-page=fonts" class="btn-back"><i class="fa fa-reply" aria-hidden="true"></i>'.$lumise->lang('Back To Lists').'</a>';
					}
					else
