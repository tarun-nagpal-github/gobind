...
<div class="lumise_wrapper">
	<div class="lumise_content">
		...
		<div class="lumise_header">
			...
			<a href="<?php echo $lumise_router->getURI();?>lumise-page=category&type=<?php echo $type; ?>" class="add_new"><?php echo $lumise->lang('Add New Category'); ?></a>
			<?php
							...
							if (empty($data_search)) {
								...
								for ($i = $start; $i < $start + $per_page; $i++) {
									...
									<tr>
										...
										<td><a href="<?php echo $lumise_router->getURI();?>lumise-page=category&type=<?php echo $type; ?>&id=<?php if(isset($cate[$i]['id'])) echo $cate[$i]['id']; ?>" class="name"><?php if(isset($cate[$i]['name'])) echo str_repeat('&mdash;', $cate[$i]['lv']).$cate[$i]['name']; ?></a></td>
										<td>
										<?php
