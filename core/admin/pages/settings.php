<?php
		...
		'tabs' => array(
			...
			'editor:' . $lumise->lang('Editor') => array(
				...
				array(
					'type' => 'toggle',
					'name' => 'share',
					'label' => $lumise->lang('Allow sharing'),
					'desc' => $lumise->lang('Allow none-admin users to share their designs'),
					'default' => 'no',
					'value' => null
				),
				array(
					'type' => 'toggle',
					'name' => 'user_print',
					'label' => $lumise->lang('Allow user print'),
					'desc' => $lumise->lang('Allow none-admin users to print their designs'),
					'default' => 'no',
					'value' => null
				),
				array(
					'type' => 'checkboxes',
					'name' => 'user_download',
					'label' => $lumise->lang('Allow user download'),
					'desc' => $lumise->lang('Allow none-admin users to download their designs as a file'),
					'default' => '',
					'value' => null,
					'options' => array(
						'jpg' => 'JPG',
						...
						'svg' => 'SVG',
						'pdf' => 'PDF',
						'lumi' => '*.lumi (importable file)'
					)
				),
				array(
					'type' => 'checkboxes',
					'name' => 'components',
					'label' => $lumise->lang('Show components'),
					'desc' => $lumise->lang('Show or hide components of editor, you also can arrange them as how you want'),
					'default' => '',
					'value' => null,
					'options' => array(
						'shop' => $lumise->lang('Shopping cart'),
						'product' => $lumise->lang('Product'),
						'templates' => $lumise->lang('Templates'),
						'cliparts' => $lumise->lang('Cliparts'),
						'text' => $lumise->lang('Text'),
						'images' => $lumise->lang('Images'),
						'shapes' => $lumise->lang('Shapes'),
						'drawing' => $lumise->lang('Drawing'),
						'layers' => $lumise->lang('Layers'),
				...
				array(
					...
					'desc' => $lumise->lang('The min width x height of images can be added'),
					'default' => '',
				...
				array(
					...
					'desc' => $lumise->lang('The max width x height of images can be added, Automatically decreases if bigger'),
					'default' => '',
				...
				array(
					...
					'desc' => $lumise->lang('The custom CSS code.'),
				),
				array(
					'type' => 'input',
					'name' => 'prefix_file',
				...
				array(
					'type' => 'radios',
					'name' => 'stages',
					'label' => $lumise->lang('Number of stages'),
					'desc' => $lumise->lang('Set number of stages to display in the page edit of products'),
					'options' => array('1' => '1 stage', '2' => '2 stages', '3' => '3 stages', '4' => '4 stages')
				),
				array(
					'type' => 'input',
					'name' => 'label_stage_1',
					'label' => $lumise->lang('Label of stage 1'),
					'default' => 'Front'
				),
				array(
					'type' => 'input',
					'name' => 'label_stage_2',
					'label' => $lumise->lang('Label of stage 2'),
					'default' => 'Back'
				),
				array(
					'type' => 'input',
					'name' => 'label_stage_3',
					'label' => $lumise->lang('Label of stage 3'),
					'default' => 'Left'
				),
				array(
					'type' => 'input',
					'name' => 'label_stage_4',
					'label' => $lumise->lang('Label of stage 4'),
					'default' => 'Right'
				),
			),
	...
	$arg['tabs']['fonts:' . $lumise->lang('Google Fonts')] = array(
		array(
			'type' => 'google_fonts',
			'name' => 'google_fonts',
	...
	//language tab
	$arg['tabs']['languages:' . $lumise->lang('Languages')] = array(
		array(
			'type' => 'dropbox',
			'name' => 'admin_lang',
	...
	//help tab
	$arg['tabs']['help:' . $lumise->lang('Help contents')] = array(
		array(
			'type' => 'input',
			'name' => 'help_title',
	...
	$arg = $lumise->apply_filter('setting_tabs', $arg);
