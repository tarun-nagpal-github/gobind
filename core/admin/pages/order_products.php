<?php
    ...
    if(
        ...
        $lumise->redirect($lumise_router->getURI().'lumise-page=order_products&order_id='.$order_id);
    }
...
?><div class="lumise_wrapper">
	...
	<div class="lumise_content">
		...
		<div class="lumise_header">
			<h2><?php printf($lumise->lang('Order %s details'), '#'.$_REQUEST['order_id']) ?></h2>
			<?php
            ...
            <div class="lumise-order-details lumise_option">
                <div class="col-3">
                    ...
                    <div class="order_status">
                        ...
                        <form action="<?php echo $lumise_router->getURI();?>lumise-page=order_products&order_id=<?php echo $order_id;?>" method="post">
			...
			<table class="lumise_table lumise_ops lumise_order_details">
				<thead>
					<tr>
                        ...
                        <th width="5%"><?php echo $lumise->lang('Size'); ?></th>
                        <th width="5%"><?php echo $lumise->lang('Orientation'); ?></th>
	                ...
	                <tr>
						...
						<td>
                            ...
                            if(isset($item['screenshots']) && $item['screenshots'] != null){
                                ...
                                foreach ($screenshots as $screenshot) {
                					echo '<img src="'.$lumise->cfg->upload_url.'orders/'.$order_id.'/'.$screenshot.'" class="lumise-order-thumbnail" />';
                				}
                            }
                        ...
                        <td><?php
                            ...
                            if(isset($data_obj->attributes)){
                                //print_r($data_obj->attributes);
                                foreach($data_obj->attributes as $att_name => $values){
                                    echo "<strong>$att_name:</strong>";
                                    if(is_array($values)){
                        ...
                        ?></td>
                        <td style="text-transform: uppercase;"><?php echo $product['size'];?></td>
                        <td><?php echo ($product['orientation'])? $lumise->lang('Landscape'): $lumise->lang('Portrait');?></td>
                        ...
                        <td>
			                ...
			                ?>">
		                        <?php echo $lumise->lang('Print Design'); ?>
		                    </a>
		                </td>
					</tr>
	                    <?php
                ...
                <tfoot class="no-border">
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <strong><?php echo $lumise->lang('Order Total:'); ?></strong>
                        </td>
                        <td>
