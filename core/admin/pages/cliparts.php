					...
					<?php
						...
						foreach ($arts as $art) { ?>
							...
							<tr>
								...
								<td><a href="<?php echo $lumise_router->getURI();?>lumise-page=clipart&id=<?php if(isset($art['id'])) echo $art['id'] ?>" class="name"><?php if(isset($art['name'])) echo $art['name']; ?></a></td>
			...
			<div class="lumise_form_group">
				...
				<div class="lumise_form_content">
					<div class="toggle">
						...
						<span class="toggle-label less" data-on="Yes" data-off="No"></span>
						<span class="toggle-handle less"></span>
					</div>
				</div>
			</div>
			<div class="lumise_form_group">
