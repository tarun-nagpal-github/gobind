...
class MysqliDb
{
  ...
  ');';
    ...
    public function where($whereProp, $whereValue = 'DBNULL', $operator = '=', $cond = 'AND')
    {
      ...
      $this->console_log('$whereProp');
      $this->console_log($whereProp);
      $this->console_log('$whereProp');

      $this->console_log('**********************************');

      $this->console_log('$whereValue');
      $this->console_log($whereValue);
      $this->console_log('$whereValue');

      // print "<pre> whereProp <br>";
      // print_r($whereProp)
      // print "<pre>";


      
      // print "<pre> whereValue <br>";
      // print_r($whereValue)
      // print "<pre>";

      
      // print "<pre> operator <br>";
      // print_r($operator)
      // print "<pre>";
    ...
    protected function _dynamicBindResults(mysqli_stmt $stmt)
    {
        ...
        $results = array();
        /**
         * @see http://php.net/manual/en/mysqli-result.fetch-fielts.php
         */
        $mysqlLongType = 252;
...
class dbObject {
    ...
    /**
     * Catches calls to undefined methots.
     *
    ...
    /**
     * Catches calls to undefined static methots.
     *
